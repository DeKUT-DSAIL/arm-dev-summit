...
<li>Installing Python</li>
 <p> 
  For this task, we will be using Python programming language so let's begin with installing it on our computers. If you have Python installed on your computer you can skip to the second requirement. For computers running on windows, <a href="https://www.python.org/ftp/python/3.9.5/python-3.9.5-amd64.exe" target="_blank">Python page</a>
</p>
